...
CREATE OR REPLACE TABLE TRUSTED_WIP.REFERENCE_DATA.industry_data (
    year NUMBER(16, 0),
...
CREATE OR REPLACE TABLE TRUSTED_WIP.REFERENCE_DATA.debt_data (
    id NUMBER(16, 0),
    ranking NUMBER(16, 0),
    debt_taken BOOLEAN,
    amount NUMBER(16, 8),
...
CREATE OR REPLACE TABLE TRUSTED_WIP.REFERENCE_DATA.invoice (
